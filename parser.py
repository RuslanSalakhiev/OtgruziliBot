...
from data import add_book, find_publisher, find_book, add_publisher
import config
...
def parse_mif(db_name, publisher_name):
    ...
    if find_publisher(db_name,publisher_name) is None: add_publisher(db_name,'МИФ')
...
def parse_corpus(db_name, publisher_name):
    ...
    if find_publisher(db_name, publisher_name) is None: add_publisher(db_name, 'Corpus')
